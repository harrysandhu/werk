...
/******/ 	return __webpack_require__(__webpack_require__.s = "./static/js/client.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _loginform = __webpack_require__(/*! ./components/loginform */ "./static/js/components/loginform.js");

var _loginform2 = _interopRequireDefault(_loginform);

var _regForm = __webpack_require__(/*! ./components/regForm */ "./static/js/components/regForm.js");

var _regForm2 = _interopRequireDefault(_regForm);

var _modeButton = __webpack_require__(/*! ./components/modeButton */ "./static/js/components/modeButton.js");
...
__webpack_require__(/*! ./test */ "./static/js/test.js");
...
var Layout = function (_Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function changeMode(e) {
      ...
      if (mode == 'login') this.setState({ mode: 'reg' });else if (mode == 'reg') this.setState({ mode: 'login' });
    }
  }, {
    key: 'formDisplay',
    value: function formDisplay() {
      if (this.state.mode == 'login') {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_modeButton2.default, { changeMode: this.changeMode, toMode: 'Register' })
        );
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_modeButton2.default, { changeMode: this.changeMode, toMode: 'Login' })
        );
      }
    }
  }, {
...
var LoginForm = function (_Component) {
    ...
    function LoginForm(props) {
        ...
        _this.handleSignupForm = _this.handleSignupForm.bind(_this);
        _this.handleUsernameInput = _this.handleUsernameInput.bind(_this);
    ...
    _createClass(LoginForm, [{
        ...
        value: function handleSignupForm(e) {
            e.preventDefault();
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    'Username:',
                    _react2.default.createElement('input', { name: 'username', onChange: this.handleUsernameInput, type: 'text' }),
                    _react2.default.createElement('br', null),
                    'Password:',
                    _react2.default.createElement('input', { name: 'password', onChange: this.handlePasswordInput, type: 'password' }),
                    _react2.default.createElement('br', null),
...
/***/ "./static/js/components/modeButton.js":
/*!********************************************!*\
  !*** ./static/js/components/modeButton.js ***!
  \********************************************/
/*! no static exports found */
...
var ModeButton = function (_Component) {
...
/***/ "./static/js/components/regForm.js":
/*!*****************************************!*\
  !*** ./static/js/components/regForm.js ***!
  \*****************************************/
/*! no static exports found */
...
var register = __webpack_require__(/*! ../functions/register */ "./static/js/functions/register.js");
...
var RegForm = function (_Component) {
    ...
    function RegForm(props) {
        ...
        _this.handleInputState = _this.handleInputState.bind(_this);
        _this.handleSignupForm = _this.handleSignupForm.bind(_this);
        return _this;
    }
    ...
    _createClass(RegForm, [{
        ...
        value: function handleInputState(e) {
        ...
        value: function handleSignupForm(e) {
            ...
            var _state = this.state,
                ...
                username_status = _state.username_status,
                password_status = _state.password_status,
        ...
        key: 'usernameStatus',
        value: function usernameStatus() {
            var username_status = this.state.username_status;

            if (username_status != null) return username_status;
        }
    }, {
        key: 'passwordStatus',
        value: function passwordStatus() {
            var password_status = this.state.password_status;
        ...
        key: 'render',
        value: function render() {
            var enabled = this.state.username_status === '' && this.state.password_status === '';
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { onSubmit: this.handleSignupForm },
                    'Username:',
                    _react2.default.createElement('input', { name: 'username', type: 'text', onChange: this.handleInputState }),
                    _react2.default.createElement('br', null),
                    'Password:',
                    _react2.default.createElement('input', { name: 'password', type: 'password', onChange: this.handleInputState }),
                    _react2.default.createElement('br', null),
                    'Confirm Password:',
                    _react2.default.createElement('input', { name: 'password2', type: 'password', onChange: this.handleInputState }),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement('input', { name: 'submit', disabled: !enabled, type: 'submit', value: 'Register' })
                )
            );
        }
    }]);
...
/***/ "./static/js/functions/register.js":
/*!*****************************************!*\
  !*** ./static/js/functions/register.js ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = {
    ...
    handleUsername: function handleUsername(self, username) {
        //check length
    ...
    handlePassword: function handlePassword(self, password2) {
    ...
    handleSignupForm: function handleSignupForm(self) {
        var _self$state = self.state,
            username = _self$state.username,
            password = _self$state.password,
            password2 = _self$state.password2,
            username_status = _self$state.username_status,
            password_status = _self$state.password_status;
...
var initialUserState = { name: '', age: 0 };
...
var tweetsReducer = function tweetsReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialTweetsState;
    var action = arguments[1];
...
var loadingState = { loading: false, error: null };
var loadReducer = function loadReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : loadingState;
    var action = arguments[1];
    ...
    switch (action.type) {
        ...
        case 'FETCH_TODOS_FULFILLED':
            {
                state = _extends({}, state, { loading: false });
                break;
            }
...
var store = (0, _redux.createStore)(reducers, (0, _redux.applyMiddleware)((0, _reduxPromiseMiddleware2.default)(), _reduxThunk2.default, (0, _reduxLogger.createLogger)()));
...
store.dispatch({
    type: 'FETCH_TODOS',
    payload: (0, _axios2.default)({ method: 'GET', 'url': 'api/todo' })
});
