...
/******/ 	return __webpack_require__(__webpack_require__.s = "./static/js/user.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./static/js/actions/userActions.js":
/*!******************************************!*\
  !*** ./static/js/actions/userActions.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./static/js/components/EditTodo.js":
/*!******************************************!*\
  !*** ./static/js/components/EditTodo.js ***!
  \******************************************/
/*! no static exports found */
...
var EditTodo = function (_Component) {
...
/***/ "./static/js/components/TodoList.js":
/*!******************************************!*\
  !*** ./static/js/components/TodoList.js ***!
  \******************************************/
/*! no static exports found */
...
var _todo = __webpack_require__(/*! ./todo */ "./static/js/components/todo.js");
...
var uf = __webpack_require__(/*! ../functions/user_functions */ "./static/js/functions/user_functions.js");
...
var TodoList = function (_Component) {
    ...
    function TodoList(props) {
        ...
        _this.handleDispatch = _this.handleDispatch.bind(_this);
        return _this;
    }
    ...
    _createClass(TodoList, [{
        ...
        value: function handleDispatch(action) {
            switch (action.type) {
                case 'TOGGLE_TODO':
                    {
                        return this.props.handleAction(action);
                        break;
                    }
                case 'DELETE_TODO':
                    {
                        return this.props.handleActions(action);
                        break;
                    }
                case 'UPDATE_TODO':
                    {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                todos.map(function (todo) {
                    _react2.default.createElement(_todo2.default, { key: todo.id, todo: todo, handleDispatch: _this2.handleDispatch });
                })
            );
        }
    }]);
...
/***/ "./static/js/components/logout.js":
/*!****************************************!*\
  !*** ./static/js/components/logout.js ***!
  \****************************************/
/*! no static exports found */
...
var _EditTodo = __webpack_require__(/*! ./EditTodo */ "./static/js/components/EditTodo.js");
  ...
  _createClass(Todo, [{
    ...
    value: function render() {
      var _props$todo = this.props.todo,
          id = _props$todo.id,
          content = _props$todo.content,
          status = _props$todo.status,
          loading = _props$todo.loading;
        ...
        if (editMode == false) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              null,
              _react2.default.createElement('input', { type: 'checkbox', onChange: this.toggleTodo, checked: status }),
              content
            ),
            _react2.default.createElement(
              'button',
          ...
          return _react2.default.createElement(_EditTodo2.default, { content: content, onSave: this.handleSave, onCancel: this.handleCancel });
        }
      }
    }
  }]);
...
module.exports = {
    loginFormProcess: function loginFormProcess(self) {
...
/***/ "./static/js/functions/user_functions.js":
/*!***********************************************!*\
  !*** ./static/js/functions/user_functions.js ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = {
    getUserData: function getUserData(self) {
        var user = {};
        (0, _axios2.default)({
            method: 'GET',
            url: '/api/session'
    ...
    /*
       ...
       * @returns bool
       */
    addTodo: function addTodo(data, self) {
        var todo = data;
    ...
    * @returns bool
    */
    getTodos: function getTodos(self) {
    ...
    toggleTodoStatus: function toggleTodoStatus(self) {
        var _self$state = self.state,
            id = _self$state.id,
            status = _self$state.status;
...
var _todosReducer = __webpack_require__(/*! ./todosReducer */ "./static/js/reducers/todosReducer.js");

var _todosReducer2 = _interopRequireDefault(_todosReducer);

var _userReducer = __webpack_require__(/*! ./userReducer */ "./static/js/reducers/userReducer.js");
...
/***/ "./static/js/reducers/todosReducer.js":
/*!********************************************!*\
  !*** ./static/js/reducers/todosReducer.js ***!
  \********************************************/
/*! no static exports found */
    ...
    *@returns A new (not mutated) state object 
    ...
    switch (action.type) {
        case 'FETCH_TODOS_PENDING':
            {
                var todos = _extends({}, state.todos);
                for (todo in todos) {
                    todo.loading = true;
                }
        ...
        case 'FETCH_TODOS_FULFILLED':
            {
                var todos = _extends({}, action.payload.data.todos);
                var todosById = [].concat(_toConsumableArray(action.payload.data.todosById));
                ...
                state = _extends({}, state, { todos: todos, todosById: todosById });
                break;
            }
        ...
        case 'ADD_TODO_FULFILLED':
            {
                ...
                *adds to todos and updates the  state
                 */
                var todos = _extends({}, action.meta.todos);
                var todosById = [].concat(_toConsumableArray(action.meta.todosById));

                var _todo = action.payload.data.todo;
                var todoId_key = _todo.id.toString();
                console.log(todoId_key);

                //add to todo
                todos[todoId_key.toString()] = _todo;
                todosById.push(todoId_key);
                console.log('logged todos hashtable, :', todos);
                state = _extends({}, state, { todos: todos, todosById: todosById });
            }
        ...
        case 'TOGGLE_TODO_PENDING':
            {
                state = _extends({}, state, { loading: true });
                break;
            }
        case 'TOGGLE_TODO_FULFILLED':
            {
                //promise returns data.todo
                var todoUpdate = action.payload.data.todo;
                var newState = _extends({}, state);
                var index = 0;
                newState.todos.map(function (todo, i) {
                ...
                console.log(todoUpdate.status);

                newState.todos[index].status = todoUpdate.status;

                newState = _extends({}, newState, { loading: false });
                return newState;
            }
...
/***/ "./static/js/reducers/userReducer.js":
/*!*******************************************!*\
  !*** ./static/js/reducers/userReducer.js ***!
  \*******************************************/
/*! no static exports found */
        ...
        case 'FETCH_USER_FULFILLED':
            {
                ...
                state = _extends({}, state, { user: action.payload.data.user, loading: false });

                break;
            }
        case 'FETCH_USER_REJECTED':
            {
                state = _extends({}, state, { error: action.payload.error });
                break;
            }
...
var _reducers = __webpack_require__(/*! ./reducers */ "./static/js/reducers/index.js");
...
var _TodoList = __webpack_require__(/*! ./components/TodoList */ "./static/js/components/TodoList.js");

var _TodoList2 = _interopRequireDefault(_TodoList);

var _logout = __webpack_require__(/*! ./components/logout */ "./static/js/components/logout.js");
...
var _userActions = __webpack_require__(/*! ./actions/userActions */ "./static/js/actions/userActions.js");
...
var uf = __webpack_require__(/*! ./functions/user_functions */ "./static/js/functions/user_functions.js");
var auth = __webpack_require__(/*! ./functions/auth */ "./static/js/functions/auth.js");
    ...
    _createClass(User, [{
        ...
        value: function render() {
            var _props = this.props,
                user = _props.user,
                userLoadingStatus = _props.userLoadingStatus;
            ...
            if (userLoadingStatus == false) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_logout2.default, { handleClick: this.logout })
                );
            } else {
                return _react2.default.createElement(
                    'div',
